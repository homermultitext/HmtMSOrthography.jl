...
$(SIGNATURES)    
"""
function tokentypes(ortho::MSOrthography)
    ortho.tokencategories
end


"""
Instantiate a MSOrthography with correct code points and token types.
...
"""
Create correct OrthographicToken for a given string in MSOrthography.
...
$(SIGNATURES)
"""
function sortWords(words, ortho::MSOrthography)
